...
const PMWorkspace: React.FC<PMWorkspaceProps> = ({ onNavigate }) => {
  ...
  const [tasks, setTasks] = useState<Task[]>([
    {
      id: 1,
      title: 'Verify NGO Budget Report',
      priority: 'high',
      due: 'Due in 2h',
      completed: false
    },
    {
      id: 2,
      title: 'Clear Duplicate ID Alerts',
      priority: 'medium',
      due: 'Due Today',
      completed: false
    },
    ...
    {
      id: 4,
      title: 'Audit Last Quarter Grants',
      priority: 'high',
      due: 'Due Tomorrow',
      completed: false
    }
  ...
  const queueItems: QueueItem[] = [
    {
      id: 1,
      beneficiary: 'Abebe Kebede',
      issueType: 'Duplicate ID',
      issueBg: 'bg-red-50 dark:bg-red-900/20',
      issueColor: 'text-red-700 dark:text-red-300',
      reportDate: 'Oct 24, 2023'
    },
    {
      id: 2,
      beneficiary: 'Fatima Ahmed',
      issueType: 'Incorrect Document',
      issueBg: 'bg-amber-50 dark:bg-amber-900/20',
      issueColor: 'text-amber-700 dark:text-amber-300',
      reportDate: 'Oct 23, 2023'
    },
    {
      id: 3,
      beneficiary: 'Samuel Tekle',
      issueType: 'Financial Discrepancy',
      issueBg: 'bg-blue-50 dark:bg-blue-900/20',
      issueColor: 'text-blue-700 dark:text-blue-300',
      reportDate: 'Oct 22, 2023'
    }
  ];
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#F8F9FA] dark:bg-slate-900">
      ...
      `}>
        ...
        <nav className="flex-1 px-4 space-y-2 overflow-y-auto">
          ...
          <NavItem 
            ...
            label="Resolved Duplications" 
            onClick={() => onNavigate?.('duplications')}
          />
          <NavItem 
        ...
        {/* User Info removed from sidebar - now only in header */}
        <div className="p-4" />
      </aside>
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-[#F8F9FA] dark:bg-slate-900 overflow-y-auto">
        {/* Header */}
        <header className="sticky top-0 z-10 bg-white/80 dark:bg-slate-900/80 
                         backdrop-blur-xl border-b border-slate-200 
                         dark:border-white/10 h-20 flex items-center 
                         justify-between px-4 lg:px-8 shrink-0">
          <div className="flex items-center gap-4 flex-1">
            ...
            {/* Page Title */}
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-[#2E8B57] 
                           to-[#3CB371] bg-clip-text text-transparent">
                Home Dashboard
              </h1>
              <p className="text-xs text-slate-500 mt-0.5">Welcome back, Project Manager</p>
            </div>
          </div>
          ...
          <div className="hidden lg:block relative w-64 mr-4">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-100 
                       dark:bg-slate-800 border-none rounded-xl 
                       text-sm focus:outline-none focus:ring-2 
                       focus:ring-[#2E8B57]/20 placeholder:text-slate-400"
            />
          </div>
        ...
        <div className="p-4 lg:p-8 space-y-8 max-w-[1400px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Approval Queue Throughput Chart */}
              ...
              <div className="p-6 border-b border-slate-200 dark:border-slate-800 
                ...
                <div className="flex gap-2">
                  <button className="px-3 py-1.5 text-xs font-bold 
                                   bg-[#2E8B57] text-white rounded-lg
                                   hover:bg-[#3CB371] transition-all
                                   hover:scale-105 active:scale-95">
                    7 Days
                  </button>
                  <button className="px-3 py-1.5 text-xs font-medium 
                                   text-slate-500 hover:bg-slate-100 
                                   dark:hover:bg-slate-800 rounded-lg
                ...
                <div className="h-64 w-full relative">
                  ...
                  <div className="flex items-end justify-around h-full relative">
                    {[
                      ...
                      { day: 'Thu', value: 55, active: false },
                      { day: 'Fri', value: 75, active: false },
                      { day: 'Sat', value: 30, active: false },
                      { day: 'Sun', value: 20, active: false }
                    ].map((item, index) => (
                      <div key={index} className="flex flex-col items-center gap-2 w-full">
                        <div 
                          className={`
                            w-12 rounded-t-xl transition-all duration-500
                            hover:scale-110 hover:-translate-y-1 cursor-pointer
                            ${item.active 
                              ? 'bg-gradient-to-t from-[#2E8B57] to-[#3CB371] shadow-lg' 
                              : 'bg-[#2E8B57]/20 hover:bg-[#2E8B57]/40'
                            }
                          `}
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl 
              ...
              <div className="p-6 border-b border-slate-200 dark:border-slate-800 
                ...
                <button className="text-[#2E8B57] text-sm font-semibold 
                                 hover:underline hover:scale-105 transition-all">
                  View All
                </button>
              </div>
              ...
              <div className="p-4 border-t border-slate-200 dark:border-slate-800">
                <button
                  ...
                  className="w-full py-3 bg-[#2E8B57]/10 text-[#2E8B57] 
                           text-sm font-bold rounded-xl hover:bg-[#2E8B57]/20 
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl 
            ...
            <div className="p-6 border-b border-slate-200 dark:border-slate-800 
              ...
              <button className="flex items-center gap-2 text-sm text-slate-500 
                               hover:text-[#2E8B57] transition-all
                               hover:scale-105 active:scale-95">
                    ...
                    <tr key={item.id} 
                      ...
                      <td className="px-6 py-4">
                        <span className="text-sm font-semibold text-slate-900 
                                       dark:text-white group-hover:text-[#2E8B57] 
                                       transition-colors">
                          {item.beneficiary}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <button className="text-[#2E8B57] hover:text-[#3CB371] 
