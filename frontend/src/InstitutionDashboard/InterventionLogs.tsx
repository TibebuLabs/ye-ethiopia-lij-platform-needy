  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-2xl 
                    max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-slideIn shadow-2xl">
        
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-slate-900 border-b 
                      border-slate-200 dark:border-slate-800 p-6 z-10">
        ...
        {step === 2 && (
          <div className="p-6 space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Intervention Title *</label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Amount (if any)</label>
                <input
                  type="number"
        ...
        {step === 3 && (
          <div className="p-6 space-y-6">
            ...
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 
                          rounded-2xl p-8 text-center hover:border-[#2E8B57] 
        ...
        {/* Footer */}
        <div className="sticky bottom-0 bg-white dark:bg-slate-900 border-t 
            ...
            <div className="flex-1 bg-white dark:bg-slate-800 rounded-xl 
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  {intervention.amount && (
                    <span className="text-xs bg-slate-100 dark:bg-slate-700 
      ...
      <div className="p-4 lg:p-8 max-w-7xl mx-auto w-full space-y-8">
              ...
              <div className="p-4 border-b border-slate-200 dark:border-slate-800">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-slate-800 
                             rounded-xl border border-slate-200 dark:border-slate-700
                             focus:outline-none focus:ring-2 focus:ring-[#2E8B57]"
                  />
                </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl 
                  ...
                  {filteredInterventions.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      <div className="size-20 mx-auto bg-slate-100 dark:bg-slate-800 
        ...
        {showReceiptModal && selectedIntervention && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-2xl 
                          max-w-2xl w-full p-6 animate-slideIn shadow-2xl">
              <button
                onClick={() => setShowReceiptModal(false)}
