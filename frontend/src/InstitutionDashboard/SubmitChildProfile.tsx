    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-2xl 
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-2xl font-bold text-amber-700 dark:text-amber-500">
          ...
          {duplicates.map((dup) => (
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <span className="px-3 py-1 bg-amber-100 dark:bg-amber-900/30 
      ...
      <div className="p-4 lg:p-8 max-w-4xl mx-auto w-full">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/10 px-4 py-2 rounded-xl">
            ...
            <div className="p-6 lg:p-8 space-y-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-slate-200 
                              dark:border-slate-700 rounded-2xl p-8 text-center
            ...
            {currentStep > 1 && (
              <button
                ...
                className="px-6 py-3 border border-slate-200 dark:border-slate-700 
                         rounded-xl hover:bg-white dark:hover:bg-slate-800 
        ...
        {/* Policy Note */}
        <div className="mt-6 bg-gradient-to-r from-amber-50 to-orange-50 
