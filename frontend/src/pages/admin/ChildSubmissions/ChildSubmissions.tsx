        ...
        <div key={entry.id} className="flex gap-4 items-start relative group">
          ...
          <div className="flex-1 pb-4">
            ...
            <p className="text-xs text-slate-500 mt-1">
              By <span className="font-bold text-slate-700">
                {entry.user}
              </span> ({entry.role})
            </p>
            
            {entry.description && (
              <div className="mt-2 text-xs bg-slate-50 p-3 rounded-lg text-slate-600
      ...
      <div className="p-4 lg:p-8 max-w-[1440px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                {activeTab === 'documents' && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 bg-slate-50 rounded-xl border border-slate-200
                      ...
                      <div className="mt-3 h-20 bg-slate-200 rounded-lg 
          ...
          <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-24">
            ...
            <div className="bg-white rounded-2xl border-2 border-[#2E8B57]/20 shadow-xl 
                ...
                <div className="mt-6">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-slate-200 
                             focus:border-[#2E8B57] focus:ring-[#2E8B57] 
                             text-sm min-h-[100px] placeholder:text-slate-400 resize-none
                             bg-slate-50"
